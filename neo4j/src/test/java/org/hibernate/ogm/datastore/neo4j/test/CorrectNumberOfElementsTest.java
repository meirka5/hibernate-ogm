...
public class CorrectNumberOfElementsTest extends JpaTestCase {
	...
	public void testSingleEntityCreationWithSequences() throws Exception {
		...
		assertExpectedMapping( "(git:DistributedRevisionControl:ENTITY {id: " + git.getId() + ", name: '" + git.getName() + "' })" );
		assertExpectedMapping( "(sequence:DistributedRevisionControl:hibernate_sequences {DistributedRevisionControl: 2 })" );
	}
