 ...
 */
public class PropertyNameWrapper extends WrappedElement {

	public static final String PREFIX = "ogm_";

	public static final String ESCAPED_ID = PREFIX + StringFactory.ID;

	public PropertyNameWrapper(Element baseElement) {
		super( baseElement );
	}

	private static String escape(String column) {
	...
	public Set<String> getPropertyKeys() {
		...
		Set<String> escaped = new HashSet<String>();
		for ( String name : propertyKeys ) {
			escaped.add( unescape( name ) );
		}
		return propertyKeys;
	}
