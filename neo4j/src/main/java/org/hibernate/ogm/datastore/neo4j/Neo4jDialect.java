...
import org.hibernate.ogm.datastore.neo4j.embedded.dialect.impl.EmbdddedNeo4jNodesTupleIterator;
...
public class Neo4jDialect extends BaseNeo4jDialect {
	...
	public ClosableIterator<Tuple> executeBackendQuery(BackendQuery<String> backendQuery, QueryParameters queryParameters, TupleContext tupleContext) {
		...
		if ( entityMetadataInformation != null ) {
			return new EmbdddedNeo4jNodesTupleIterator( result, entityMetadataInformation.getEntityKeyMetadata(), tupleContext );
		}
