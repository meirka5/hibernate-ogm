 ...
 */
public class EmbdddedNeo4jNodesTupleIterator extends EmbeddedNeo4jMapsTupleIterator {

	private final EntityKeyMetadata entityKeyMetadata;
	private final TupleContext tupleContext;

	public EmbdddedNeo4jNodesTupleIterator(Result result, EntityKeyMetadata entityKeyMetadata, TupleContext tupleContext) {
		super( result );
