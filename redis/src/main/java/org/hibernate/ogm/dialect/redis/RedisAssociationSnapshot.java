 ...
 */
public final class RedisAssociationSnapshot implements AssociationSnapshot {

	private final Map<RowKey, Map<String, String>> associationMap;

	public RedisAssociationSnapshot() {
		this.associationMap = new HashMap<RowKey, Map<String, String>>();
	}
