...
public class SkipByGridDialectSelfJpaTest extends JpaTestCase {
	...
	@Test
	@SkipByGridDialect({
		GridDialectType.HASHMAP, GridDialectType.INFINISPAN, GridDialectType.MONGODB, GridDialectType.EHCACHE, GridDialectType.NEO4J, GridDialectType.COUCHDB, GridDialectType.HOTROD
