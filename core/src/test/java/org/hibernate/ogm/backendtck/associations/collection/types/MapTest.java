...
public class MapTest extends OgmTestCase {
	...
	// Each association must have a different table. For this reason we decided to update the tests and rename the tables
	// I'll leave this here just in case someone decides to change the test.
