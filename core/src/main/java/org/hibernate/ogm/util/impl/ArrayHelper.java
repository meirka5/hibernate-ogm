...
public class ArrayHelper {
	...
	public static <T> T[] concat(T[] first, T[] second) {
		...
		T[] C = (T[]) Array.newInstance( first.getClass().getComponentType(), firstLength + secondLength );
		System.arraycopy( first, 0, C, 0, firstLength );
		System.arraycopy( second, 0, C, firstLength, secondLength );
