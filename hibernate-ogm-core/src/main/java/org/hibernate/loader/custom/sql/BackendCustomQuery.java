...
import org.hibernate.loader.custom.sql.SQLQueryReturnProcessor.ResultAliasContext;
...
public class BackendCustomQuery implements CustomQuery {
	...
	public BackendCustomQuery(final String nosqlQuery, final NativeSQLQueryReturn[] queryReturns, final Collection<?> additionalQuerySpaces,
		...
		ResultAliasContext aliasContext = processor.process();
		customQueryReturns.addAll( processor.generateCustomReturns( false ) );
